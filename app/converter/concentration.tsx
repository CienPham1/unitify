...
import { concentrationUnits } from '@/constants/units';
import { convertConcentration } from '@/utils/converters';
import { useUserStore } from '@/store/user-store';
import Colors from '@/constants/colors';

export default function ConcentrationConverterScreen() {
  ...
  const handleConversion = (value: number, fromUnit: string, toUnit: string) => {
    const result = convertConcentration(value, fromUnit, toUnit);
